...
public class GatewayConfig {
    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
             ...
             * Special: Uses API key resolver for rate limiting (merchants have different limits)
             */
 ...
 * Different tenants (banks) have different rate limits based on their subscription.
 */
 ...
 * 
 * Merchants use API keys for authentication. Each merchant has their own rate limit
