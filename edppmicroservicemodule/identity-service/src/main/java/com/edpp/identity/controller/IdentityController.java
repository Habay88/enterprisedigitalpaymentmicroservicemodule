...
import com.edpp.identity.responsedto.ResponseApi;
...
public class IdentityController {
    ...
    public ResponseEntity<ResponseApi<CustomerResponse>> onboardCustomer(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ResponseApi.<CustomerResponse>builder()
                        .success(true)
    ...
    public ResponseEntity<ResponseApi<CustomerResponse>> getCustomer(@PathVariable String cifNumber) {
        ...
        return ResponseEntity.ok(ResponseApi.<CustomerResponse>builder()
                .success(true)
    ...
    public ResponseEntity<ResponseApi<CustomerResponse>> getCustomerByBvn(@PathVariable String bvn) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ResponseApi<CustomerResponse>> getCustomerByNin(@PathVariable String nin) {
    ...
    public ResponseEntity<ResponseApi<CustomerResponse>> getCustomerByEmail(@PathVariable String email) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ResponseApi<PageResponse<CustomerResponse>>> getAllCustomers(
        ...
        Page<CustomerResponse> responsePage = customersPage.map(customerMapper::toResponse);
        ...
        return ResponseEntity.ok(ResponseApi.<PageResponse<CustomerResponse>>builder()
                .success(true)
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ResponseApi<PageResponse<CustomerResponse>>> searchCustomers(
        ...
        Page<CustomerResponse> responsePage = customers.map(customerMapper::toResponse);
    ...
    public ResponseEntity<ResponseApi<CustomerResponse>> updateKyc(
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ResponseApi<CustomerResponse>> blockCustomer(
            @PathVariable String cifNumber,
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ResponseApi<CustomerResponse>> unblockCustomer(
            @PathVariable String cifNumber,
            @RequestParam String reason,
            @Parameter(hidden = true) @AuthenticationPrincipal UserDetails currentUser) {
    ...
    public ResponseEntity<ResponseApi<CustomerResponse>> verifyBvn(
            @PathVariable String cifNumber,
    ...
    public ResponseEntity<ResponseApi<CustomerResponse>> verifyNin(
            @PathVariable String cifNumber,
    ...
    public ResponseEntity<ResponseApi<Boolean>> checkCustomerExists(@PathVariable String cifNumber) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ResponseApi<Map<String, Object>>> getCustomerStats() {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ResponseApi<Void>> deactivateCustomer(
            @PathVariable String cifNumber,
            @RequestParam String reason,
            @Parameter(hidden = true) @AuthenticationPrincipal UserDetails currentUser) {
